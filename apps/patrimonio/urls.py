...
urlpatterns = [
    ...
    path('conferencia/confirmar-item/<int:pk>/',          views.conferencia_confirmar_item,        name='conferencia_confirmar_item'),
    path('conferencia/finalizar/',                        views.conferencia_finalizar,             name='conferencia_finalizar'),
